        ...
        >
          {loading ? (
            ...
            <span
              ...
              className="inline-flex items-center justify-center leading-none [&_svg]:block [&_svg]:stroke-[1.5] [&_svg]:transition-[stroke-width] [&_svg]:duration-80 group-hover:[&_svg]:stroke-[2]"
            >
              {label}
            </span>
          ) : (
