  ...
  return (
    <main className="privacy-shell">
      <header>
        ...
        <h1>你的书签属于你。</h1>
        <p>
          生效日期：2026 年 7 月 30 日。本政策说明 Aarre 浏览器扩展在本机处理什么、哪些请求会离开设备，以及你如何带走自己的数据。
        </p>
      </header>
      ...
      <section>
        ...
        <dl>
          ...
          <div>
            ...
            <dd>读取当前页面并打开书签；只在已收藏的前台页面采集本机快照。</dd>
          </div>
          <div>
            <dt>history</dt>
          ...
          <div>
            <dt>optional host access</dt>
            <dd>只在你启动全目录扫描或开启快照时申请，用于直接访问收藏的网站。</dd>
          </div>
          <div>
      ...
      <section>
        <h2>敏感页面与本机快照</h2>
        <p>
          无痕窗口、内网与本地地址、银行、支付和医疗域名不会采集快照。你还可以在设置里追加排除域名或完全关闭快照。快照只在已收藏页面位于前台并稳定停留后产生。
        </p>
      </section>
