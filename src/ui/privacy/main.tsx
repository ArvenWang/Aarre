    ...
    <main className="privacy-shell">
      ...
      <section>
        ...
        <p>
          ...
          Cookie。Aarre 不使用第三方截图服务、通用图标代理或域名画像服务。
        </p>
        <h3>可选的跨设备同步</h3>
        <p>
          云端默认关闭，且本构建只有在已配置正式 Aarre 服务时才显示可连接状态。连接后你仍需选择范围：“仅文字与设置”会加密同步摘要、标签、主题、别名、备注、设置、稳定会话、报告、保护规则与恢复信息；“完整云端备份”还会把页面快照、封面和站点标识上传到腾讯云私有 COS。图片和元数据由服务端加密保护，但这不是只有你能解密的端到端加密。
        </p>
        <p>
