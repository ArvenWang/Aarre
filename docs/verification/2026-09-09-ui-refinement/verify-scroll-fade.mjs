...
await p.screenshot({path:out+'final/menu-scroll-drag.png'});
...
await p.screenshot({path:out+'final/menu-scroll-fading.png'});
...
await p.screenshot({path:out+'final/menu-scroll-idle.png'});
