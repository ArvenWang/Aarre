...
const out=resolve(root,'outputs'),name='Bookmark-Layer-0.6.2';
...
assert(build.version==='0.6.2'&&build.cleanSource===true,'Build identity');
...
assert([manifest,zippedManifest,sourceManifest,sourcePackage].every(x=>x.version==='0.6.2'),'Version mismatch');
